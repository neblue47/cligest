                ...
                <div class="page-content">
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            <div class=" pull-left">
                                <div class="page-title">Pagamentos - Exames</div>
                            </div>
				                    ...
				                    <div class="body">
				                    	...
				                    	<div class="card-body ">
	                                     <table class="table display" id="example1" style="width:100%;">
	                                        ...
	                                        <tbody>
	                                        <c:forEach var="at" items="${lsexames }">
	                                        <tr class="odd gradeX">
												<td class=" ">${at.servico }</td>
												<td class="center">${at.preco+(at.taxa/100*at.preco)}</td>
											</tr>
	                                        </c:forEach>
											</tbody>
	                                    </table>
                                                    ...
                                                    <form action="#" method="post"  > 
											          <div class="widget-title">
												         ...
												         <div class="pull-right">
												            ...
												            <a href="navegacaoft?mods=fat&pag=listaexa"  class="btn btn-default btn-sm"  >
															      Cancelar
															</a>	  
											            </div>                    
											        </form>	
