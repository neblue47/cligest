...
/**
 * Servlet implementation class UtilizadorController
 */
...
public class UtilizadorController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			if(ismultipart){
				...
				try
				{
					...
					String nomeUS = primeironome.toLowerCase().trim() + "."+ultimonome.toLowerCase().trim();
					...
					String numFun  	= _funcionarioDAO.getNumOutro();
		...
		response.sendRedirect("navegacao?mods=ad&pag=users");
	}
