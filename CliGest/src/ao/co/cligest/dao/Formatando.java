...
public class Formatando {
	...
	public String novoGUID()
	{
		long num =  new Random(10090).nextLong();
...
public String transforma(String frase){
	...
	public List<Diverso> getAnos(){
		ArrayList<Diverso> anos = new ArrayList<Diverso>();
		int ano;
		Calendar cal = Calendar.getInstance();
		ano = cal.get(Calendar.YEAR);
		for(int i = 0; i<10;i++){
			Diverso auxs = new Diverso();
			auxs.setAno(ano+i);
			anos.add(auxs);
		}
		return anos;
