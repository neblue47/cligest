...
<!-- start page content -->
                                ...
                                <div class="card-body ">
                                     <table class="table display" id="example1" style="width:100%;">
                                        ...
                                        <tr class="odd gradeX">
												...
												<td class="center">
													<a href="navegacaoft?mods=fat&pag=pagarexa&codcs=${pc.FK_consulta_confirmada}"class="btn btn-primary btn-xs" title="Pagar">
														<i class="fa fa-credit-card"></i>
													</a>
													 
													<a onclick="CancelAgenda('${pc.FK_consulta_confirmada}')" class="btn btn-danger btn-xs" title="Cancelar">
            ...
            function CancelAgenda(codcs)
            {
          	  ...
          	  swal({
          		  title: "",
          		  text: "Pretende cancelar a exame?",
          		  icon: "warning",
          		  buttons: true,
          		  dangerMode: true,
          		})
