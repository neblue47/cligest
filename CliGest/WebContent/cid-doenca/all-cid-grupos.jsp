                    ...
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            ...
                            <ol class="breadcrumb page-breadcrumb pull-right">
                                ...
                                <li class="active">Grupos CIDs</li>
                            </ol>
                        </div>
                    </div>
                    <div class="row">
                                        ...
                                        <div class="row">
					                        <div class="col-md-12">
					                            <div class="card card-topline-red">
					                                <div class="card-head">
					                                    <header>LISTA DE GRUPOS DE CID</header>					                                     
					                                </div>
					                                <div class="card-body ">
					                                    <table class="table display" id="example1" style="width:100%;" data-page-length="10" data-page-list = "false">
					                                        <thead>
					                                            <tr>
					                                                ...
					                                                <th class="left"  > Capitulo Associado </th>					                                                 
					                                            </tr>
					                                        </thead>
					                                        <tbody>
					                                        <c:forEach items="${lsGruposCid}" var="at">
																<tr class="odd gradeX">
																	<td class="center" width="15%">${at.codigoGrupo }</td>
																	<td class="left" width="55%">${at.descricaoGrupo }</td>
																	<td class="left" width="20%">${at.capitulolistado }</td> 																	 
																</tr>
																</c:forEach>
															</tbody>
					                                    </table>
